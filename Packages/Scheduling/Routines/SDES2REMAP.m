SDES2REMAP ;ALB/BWF/JAS,TJB - REMAP DIVISION/CLINIC ; JULY 14, 2025
 ;;5.3;Scheduling;**908,917**;Aug 13, 1993;Build 2
...
REMAP(RESULT,SDCONTEXT,SDINPUT) ;
 N ERRORS,VALDATES,STARTDATE,ENDDATE,QUEUEREMAP,TASKRES,GBL,SDUSER,CLINIEN
...
REMAPFOREGROUND(GBL,SDUSER) ;
 N DIVISIONIEN,CLINICIEN,TMPCOUNT,CLINIEN
