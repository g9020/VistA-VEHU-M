SDES2CRTCLNAVAL2 ;ALB/BLB,JDJ/BLB - SDES2 SET CLINIC AVAILABILITY ;SEP 08, 2025
 ;;5.3;Scheduling;**904,914,919**;Aug 13, 1993;Build 5
...
CREATEAVAIL(AVAILABILITY,SDCONTEXT,SLOTSTOCANCEL,CLINICIEN,CLINICSTARTHOUR,SDDISPPERHR,SDCLINSTARTHR,NUMBEROFENTRIES,INPUTS,INDEFINITEUNTIL,RETURNAVAIL,ERRORS) ;
 ...
 ..D CREATEAVAIL^SDES2UTIL1(.SDRETURN,CLINICIEN,DATES,$G(TIMES),$S($G(AVAILABILITY("TIMESLOT",TIMESLOTCOUNT,"NUMBER OF SLOTS",COUNT)):$G(AVAILABILITY("TIMESLOT",TIMESLOTCOUNT,"NUMBER OF SLOTS",COUNT)),1:""),.INDEFINITEUNTIL)
 ..K DATES,TIMES
 ..;
