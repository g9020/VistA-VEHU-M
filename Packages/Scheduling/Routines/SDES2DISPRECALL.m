SDES2DISPRECALL ;ALB/BWF,JAS,JHC - DISPOSITION RECALL REQUEST; OCT 30, 2025
 ;;5.3;Scheduling;**866,895,922**;Aug 13, 1993;Build 7
...
DISPRECALL(JSONRETURN,SDCONTEXT,SDINPUT) ; add a disposition and delete an entry from the RECALL REMINDERS file (403.5)
 N ERRORS,FILEDATA,PROVIDER,RECALLRETURN,DELUSER
 ; validate context
