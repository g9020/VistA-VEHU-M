SDES2NOSHOW ;ALB/BLB,BLB,JAS,MGD,BLB,LAB,TJB - SDES2 NO-SHOW ;Nov 05,2025
 ;;5.3;Scheduling;**871,875,889,915,919,927**;Aug 13, 1993;Build 15
...
NOSHOW(JSON,SDCONTEXT,NOSHOW) ;
 ...
 ;
 I REQUESTTYPE="APPT" D NOSHOW40985(REQUESTIEN,PARENTREQUEST,APPTIEN)
...
NOSHOW2(APPTDATETIME,DFN,USERID) ;
 ...
 Q
 ;
NOSHOW40985(REQUESTIEN,PARENTREQUEST,APPTIEN) ;
 N FDA,IENS,ERROR
 ;
 S IENS=REQUESTIEN_","
