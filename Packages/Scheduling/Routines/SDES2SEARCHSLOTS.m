SDES2SEARCHSLOTS ;ALB/BLB,MCB,BLB,JAS - SDES2 SEARCH CLINIC SLOTS ;Aug 01, 2025
 ;;5.3;Scheduling;**897,899,908,918**;May 28, 2025@8:05pm 1993;Build 4
 ;;Per VHA Directive 6402, this routine should not be modified
 ;
 Q
 ;
SEARCH(JSON,SDCONTEXT,SEARCH) ;
 N ERRORS,WEEKDAYS,NUMBEROFAPPTS,RECURRING,OCCURRING,MATCHINGSLOTS,FREQUENCY,SLOTS,CONSECUTIVEDAYS,STARTDATE,%DT,DIERR,I
 ;
