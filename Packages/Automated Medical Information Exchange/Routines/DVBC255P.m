...
VUPDATE ; MINIMUM AND PREVIOUS CAPRI VERSION UPDATES
 ...
 D BMES^XPDUTL("Taskman: DVBA CAPRI NRE PROCESS TM.  "_$S(DVBVER<0:"Failed",1:"Success")_" ("_$P(DVBVER,"^",2,$L(DVBVER))_")")
 ;
 ...
 D BMES^XPDUTL("Taskman: DVBA CAPRI NRE PURGE TM.  "_$S(DVBVER<0:"Failed",1:"Success")_" ("_$P(DVBVER,"^",2,$L(DVBVER))_")")
 ;
 ;Disable current 2507 AMIE Batch Printing
 S DVBVER=$$DISABLETASKMAN("DVBA C PRINT NEW C&P REQ TM")
 D BMES^XPDUTL("Disable Taskman: DVBA C PRINT NEW C&P REQ TM.  "_$S(DVBVER<0:"Failed",1:"Success")_" ("_$P(DVBVER,"^",2,$L(DVBVER))_")")
 K DA,DIE,DR
 ;CAPRI-21773 : NGC - End
 ;
